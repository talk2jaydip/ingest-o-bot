...
```bash
# In .env file (NEW NAMES)
MEDIA_DESCRIBER_MODE=gpt4o  # or content_understanding
...
# AZURE_OPENAI_VISION_DEPLOYMENT formerly: AZURE_OPENAI_DEPLOYMENT_VISION
```
...
# Deprecated name: AZURE_MEDIA_DESCRIBER
```
