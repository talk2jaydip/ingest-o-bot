# Pipeline Validation Feature - Reference

**Note:** This document references environment variable names. See [Environment Variables Guide](12_ENVIRONMENT_VARIABLES.md) for the updated generic naming convention.
...
*Deprecated names still supported: AZURE_OFFICE_EXTRACTOR_MODE, AZURE_INPUT_MODE, AZURE_ARTIFACTS_MODE*
...
EXTRACTION_OFFLINE_FALLBACK=true
```

*Deprecated names still supported: AZURE_OFFICE_EXTRACTOR_MODE, AZURE_OFFICE_OFFLINE_FALLBACK*
