...
# Examples:
# - Single file: AZURE_LOCAL_GLOB=samples/sample.pdf
# - All PDFs: AZURE_LOCAL_GLOB=./documents/*.pdf
# - All files: AZURE_LOCAL_GLOB=./documents/**/*
# - Multiple types: AZURE_LOCAL_GLOB=./documents/**/*.{pdf,txt,md}
...
# ==========================================
# Artifacts: OVERRIDE to use blob
# ==========================================
...
# ==========================================
# Artifacts: OVERRIDE to use local
# ==========================================
...
# .env
AZURE_INPUT_MODE=local
AZURE_LOCAL_GLOB=./test-data/*.pdf
...
| Variable | Required When | Purpose | Example |
|----------|---------------|---------|---------|
| `AZURE_INPUT_MODE` | Always | Where to read files from | `local` or `blob` |
| `AZURE_LOCAL_GLOB` | Input=local | File pattern to match | `./data/*.pdf` |
...
| Variable | Required When | Purpose | Example |
|----------|---------------|---------|---------|
| `AZURE_ARTIFACTS_MODE` | Override needed | Explicit mode | `local` or `blob` |
| `AZURE_STORE_ARTIFACTS_TO_BLOB` | Local→Blob override | Force blob artifacts | `true` |
| `AZURE_ARTIFACTS_DIR` | Artifacts=local | Local directory path | `./artifacts` |
| `AZURE_BLOB_CONTAINER_PREFIX` | Artifacts=blob | Container prefix | `my-prod` |
