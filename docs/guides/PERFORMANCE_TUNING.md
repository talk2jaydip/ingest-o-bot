...
**Checklist:**
1. ✅ Check `AZURE_USE_INTEGRATED_VECTORIZATION=true` is set
...
**Solution:**
1. Reduce `AZURE_MAX_WORKERS` (fewer concurrent documents)
